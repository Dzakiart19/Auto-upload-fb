...
const userStates = new Map<string | number, {
  step: 'awaiting_media' | 'awaiting_title';
  mediaType?: 'video' | 'photo';
  mediaFileId?: string;
      ...
      handler: async (c) => {
        ...
        try {
          ...
          if (photo && Array.isArray(photo) && photo.length > 0) {
            ...
            await sendTelegramMessage(
              chatId,
              '✅ Foto diterima!\n\n📝 Sekarang, kirim <b>judul/caption</b> untuk foto ini:'
            );
            return c.text("OK", 200);
          }
          ...
          if (currentState && text) {
            if (currentState.step === 'awaiting_title') {
              ...
              try {
                ...
                // NOTE: description is empty for manual upload, hashtags will be auto-generated
                ...
                await handler(mastra, {
                  ...
                  payload: {
                    ...
                    mediaType: mediaType,
                    title: title,
                    description: '', // Empty, hashtags will be auto-generated by workflow
                    userName,
                  },
                } as TriggerInfoTelegramOnNewMessage);
              } finally {
